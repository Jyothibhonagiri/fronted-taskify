...
function Tasklist() {
    ...
    const [taskSummary, setTaskSummary] = useState({ TotalCount: 0,AvailableTask:0, InProgressCount: 0, completedCount: 0, NotStartedCount: 0 })
    const getAllTasks = () => {
    ...
    return (
        <div className="container">
            ...
            <div className="row mt-3">
                ...
                <div className="col-md-3">
                    <div className="card text-center mb-3" style={{ borderBottom: "5px solid red" }}>
                        <div className="card-body">
                            <h5 className="card-title">NotStarted Task</h5>
                            <p className="card-text">{taskSummary.NotStartedCount}</p>
                        </div>
                    </div>
